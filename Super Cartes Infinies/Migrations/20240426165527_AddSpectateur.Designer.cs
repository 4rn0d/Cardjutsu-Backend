...
namespace Super_Cartes_Infinies.Migrations
{
    ...
    [Migration("20240426165527_AddSpectateur")]
    partial class AddSpectateur
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "User1Id",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "344b8aa9-6212-4566-b4fa-f4ca7d3d9d59",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e10836ca-34be-40f0-9cad-c67541be68e3",
                        ...
                        new
                        {
                            Id = "User2Id",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "69047ad5-1ebb-4539-b2f3-81a87683b18f",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a89afedb-a007-4800-8830-c45e5fd13f20",
                            TwoFactorEnabled = false
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "708b60a1-1517-4dfc-b23e-eaaebeb512e1",
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "ADMIN@ADMIN.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAECRZileQwl4NQwksdi8lwyd6fxQ3+JGVjZ2haPolBDIZ1TcyfrL0CdTMAKU4368Erg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "12915b24-14d3-4fea-bd2d-7ea2e22591ed",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Super_Cartes_Infinies.Models.Player", b =>
                {
                    ...
                    b.HasOne("Super_Cartes_Infinies.Models.Match", null)
                        .WithMany("SpectateurBannis")
                        .HasForeignKey("MatchId1");

                    b.HasOne("Super_Cartes_Infinies.Models.Player", null)
                        .WithMany("MutedPlayers")
                        .HasForeignKey("PlayerId");
            ...
            modelBuilder.Entity("Super_Cartes_Infinies.Models.Match", b =>
                {
                    ...
                    b.Navigation("Spectateur");

                    b.Navigation("SpectateurBannis");
                });
